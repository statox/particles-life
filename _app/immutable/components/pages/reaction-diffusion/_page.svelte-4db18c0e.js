...
`;function We(o){let e,t,n;return{c(){e=L("canvas"),this.h()},l(r){e=I(r,"CANVAS",{id:!0,width:!0,height:!0,class:!0}),P(e).forEach(v),this.h()},h(){y(e,"id","canvas"),y(e,"width",o[0].width),y(e,"height",o[0].height),y(e,"class","svelte-1b0ol19")},m(r,i){k(r,e,i),t||(n=[X(e,"mousemove",o[1]),X(e,"mousedown",q(o[2])),X(e,"mouseup",o[2]),X(e,"contextmenu",q(Fe))],t=!0)},p:S,i:S,o:S,d(r){r&&v(e),t=!1,_t(n)}}}const rt=11,Fe=o=>o;function Ne(o){const e={width:window.innerWidth-50,height:window.innerHeight-10},t={presetParams:4,colors:"grayscale",initialConditions:"randomSpots",reset:()=>f(),pause:!1},n={pressedLeft:!1,pressedRight:!1,x:0,y:0,penSize:3},r={iteration:0},i={f:Z[t.presetParams].f,k:Z[t.presetParams].k};let a,s;const l=async()=>{const u=await tt(()=>import("../../../chunks/dat.gui.module-69d90d27.js"),[],import.meta.url);a=new u.GUI,a.domElement.setAttribute("style","background-color: black"),a.add(i,"f").name("Feed rate").listen(),a.add(i,"k").name("Kill rate").listen(),a.add(t,"pause").name("Pause"),a.add(t,"reset").name("Reset simulation"),a.add(t,"colors",["grayscale","blackWhite","whiteBlack","raw","timeBasedBlue"]);const p=Z.reduce((b,A,x)=>(b[A.name]=x,b),{});a.add(t,"presetParams",p).onFinishChange(()=>{i.f=Z[t.presetParams].f,i.k=Z[t.presetParams].k});const d={"Random spots":"randomSpots","Middle spot":"middleSpot","Middle + random":"middleCircleAndRandomSpots"};a.add(t,"initialConditions",d).onFinishChange(t.reset);const g=a.add(r,"iteration").listen();g.domElement.style.pointerEvents="none",a.add(n,"penSize",1,rt,1).name("Pen size")},m=()=>{document.addEventListener("keydown",u=>{if(u.code==="Space")return t.pause=!t.pause,u.preventDefault();if(u.code==="KeyR")return f(),u.preventDefault()})},f=()=>{const u=document.getElementById("canvas");if(!u)throw new Error("Canvas container not ready");s&&s.destroy(),s=et({extensions:["OES_texture_float"],canvas:u}),r.iteration=0;const p=2**rt;let d;t.initialConditions==="randomSpots"?d=Ce(p,.001):t.initialConditions==="middleCircleAndRandomSpots"?d=Be(p,.005,.05):d=Re(p,.02);const g=Array(2).fill(0).map(()=>s.framebuffer({color:s.texture({radius:p,data:d,wrap:"repeat",type:"float"}),depthStencil:!1})),b=s({frag:Le,vert:z,attributes:{position:[-4,-4,4,-4,0,4]},count:3,uniforms:{iteration:s.prop("iteration"),prevState:B=>g[(B.tick+1)%2]}}),A=s({frag:Pe,vert:z,attributes:{position:[-4,-4,4,-4,0,4]},count:3,uniforms:{iteration:s.prop("iteration"),prevState:B=>g[(B.tick+1)%2]}}),x=s({frag:Me,vert:z,attributes:{position:[-4,-4,4,-4,0,4]},count:3,uniforms:{iteration:s.prop("iteration"),prevState:B=>g[(B.tick+1)%2]}}),nt=s({frag:Te,vert:z,attributes:{position:[-4,-4,4,-4,0,4]},count:3,uniforms:{iteration:s.prop("iteration"),prevState:B=>g[(B.tick+1)%2]}}),kt=s({frag:Ie,vert:z,attributes:{position:[-4,-4,4,-4,0,4]},count:3,uniforms:{iteration:s.prop("iteration"),prevState:B=>g[(B.tick+1)%2]}}),Dt=s({frag:Ee,vert:z,attributes:{position:[-4,-4,4,-4,0,4]},count:3,framebuffer:B=>g[(B.tick+1)%2],uniforms:{prevState:B=>g[B.tick%2],Da:s.prop("Da"),Db:s.prop("Db"),f:s.prop("f"),k:s.prop("k"),radius:p,pauseSimulation:s.prop("pauseSimulation"),mousePosition:s.prop("mousePosition"),penRadius:s.prop("penRadius"),penIsActive:s.prop("penIsActive"),eraserIsActive:s.prop("eraserIsActive")}});s.frame(()=>{t.pause||r.iteration++,Dt({Da:1,Db:.5,pauseSimulation:t.pause,mousePosition:[n.x,n.y],penRadius:1/2**(rt-n.penSize),penIsActive:n.pressedLeft,eraserIsActive:n.pressedRight,...i}),t.colors==="grayscale"?A({iteration:r.iteration}):t.colors==="timeBasedBlue"?kt({iteration:r.iteration}):t.colors==="blackWhite"?x({iteration:r.iteration}):t.colors==="whiteBlack"?nt({iteration:r.iteration}):b({iteration:r.iteration})})},c=u=>{if(!u.currentTarget)throw new Error("No target for the onmousemove event");if(!u.currentTarget.width||!u.currentTarget.height)throw new Error("No target dimensions for the onmousemove event target");var p=u.currentTarget.getBoundingClientRect();const d=u.clientX-p.left,g=u.clientY-p.top,{width:b,height:A}=u.currentTarget,x=d/b,nt=(A-g)/A;n.x=x,n.y=nt},h=u=>{if(![0,2].includes(u.button)||!["mouseup","mousedown"].includes(u.type))return;let p=u.type==="mousedown";u.button===0&&(n.pressedLeft=p),u.button===2&&(n.pressedRight=p)};return j(()=>{l(),m(),f()}),at(()=>{a.destroy(),s.destroy()}),[e,c,h]}class Oe extends T{constructor(e){super(),W(this,e,Ne,We,F,{})}}function gt(o,e,t){const n=o.slice();return n[1]=e[t],n}function vt(o,e,t){const n=o.slice();return n[1]=e[t],n}function Ve(o){let e;return{c(){e=O("About")},l(t){e=V(t,"About")},m(t,n){k(t,e,n)},d(t){t&&v(e)}}}function Xe(o){let e=o[1].title+"",t;return{c(){t=O(e)},l(n){t=V(n,e)},m(n,r){k(n,t,r)},p:S,d(n){n&&v(t)}}}function yt(o){let e,t;return e=new bt({props:{$$slots:{default:[Xe]},$$scope:{ctx:o}}}),{c(){C(e.$$.fragment)},l(n){M(e.$$.fragment,n)},m(n,r){R(e,n,r),t=!0},p(n,r){const i={};r&64&&(i.$$scope={dirty:r,ctx:n}),e.$set(i)},i(n){t||(w(e.$$.fragment,n),t=!0)},o(n){D(e.$$.fragment,n),t=!1},d(n){E(e,n)}}}function ze(o){let e,t,n,r;e=new bt({props:{$$slots:{default:[Ve]},$$scope:{ctx:o}}});let i=o[0],a=[];for(let l=0;l<i.length;l+=1)a[l]=yt(vt(o,i,l));const s=l=>D(a[l],1,1,()=>{a[l]=null});return{c(){C(e.$$.fragment),t=H();for(let l=0;l<a.length;l+=1)a[l].c();n=J()},l(l){M(e.$$.fragment,l),t=Q(l);for(let m=0;m<a.length;m+=1)a[m].l(l);n=J()},m(l,m){R(e,l,m),k(l,t,m);for(let f=0;f<a.length;f+=1)a[f].m(l,m);k(l,n,m),r=!0},p(l,m){const f={};if(m&64&&(f.$$scope={dirty:m,ctx:l}),e.$set(f),m&1){i=l[0];let c;for(c=0;c<i.length;c+=1){const h=vt(l,i,c);a[c]?(a[c].p(h,m),w(a[c],1)):(a[c]=yt(h),a[c].c(),w(a[c],1),a[c].m(n.parentNode,n))}for(it(),c=i.length;c<a.length;c+=1)s(c);st()}},i(l){if(!r){w(e.$$.fragment,l);for(let m=0;m<i.length;m+=1)w(a[m]);r=!0}},o(l){D(e.$$.fragment,l),a=a.filter(Boolean);for(let m=0;m<a.length;m+=1)D(a[m]);r=!1},d(l){E(e,l),l&&v(t),St(a,l),l&&v(n)}}}function Ge(o){let e,t,n,r,i,a,s,l,m,f,c,h;return{c(){e=L("p"),t=O("Experiments with "),n=L("a"),r=O("Reaction-diffusion systems"),i=H(),a=L("p"),s=O("The code is based on "),l=L("a"),m=O("this tutorial"),f=O(`
                ...
                but reimplemented in a glsl shader with
                `),c=I(g,"A",{href:!0,target:!0});var A=P(c);h=V(A,"regl"),A.forEach(v),g.forEach(v),this.h()},h(){y(n,"href","https://en.wikipedia.org/wiki/Reaction%E2%80%93diffusion_system"),y(n,"target","none"),y(l,"href","https://karlsims.com/rd.html"),y(l,"target","none"),y(c,"href","https://github.com/regl-project/regl"),y(c,"target","none")},m(u,p){k(u,e,p),N(e,t),N(e,n),N(n,r),k(u,i,p),k(u,a,p),N(a,s),N(a,l),N(l,m),N(a,f),N(a,c),N(c,h)},p:S,d(u){u&&v(e),u&&v(i),u&&v(a)}}}function Ue(o){let e,t,n;var r=o[1].component;function i(a){return{}}return r&&(e=ct(r,i())),{c(){e&&C(e.$$.fragment),t=H()},l(a){e&&M(e.$$.fragment,a),t=Q(a)},m(a,s){e&&R(e,a,s),k(a,t,s),n=!0},p(a,s){if(r!==(r=a[1].component)){if(e){it();const l=e;D(l.$$.fragment,1,0,()=>{E(l,1)}),st()}r?(e=ct(r,i()),C(e.$$.fragment),w(e.$$.fragment,1),R(e,t.parentNode,t)):e=null}},i(a){n||(e&&w(e.$$.fragment,a),n=!0)},o(a){e&&D(e.$$.fragment,a),n=!1},d(a){e&&E(e,a),a&&v(t)}}}function $t(o){let e,t;return e=new wt({props:{$$slots:{default:[Ue]},$$scope:{ctx:o}}}),{c(){C(e.$$.fragment)},l(n){M(e.$$.fragment,n)},m(n,r){R(e,n,r),t=!0},p(n,r){const i={};r&64&&(i.$$scope={dirty:r,ctx:n}),e.$set(i)},i(n){t||(w(e.$$.fragment,n),t=!0)},o(n){D(e.$$.fragment,n),t=!1},d(n){E(e,n)}}}function Ke(o){let e,t,n,r,i,a;e=new Ct({props:{$$slots:{default:[ze]},$$scope:{ctx:o}}}),n=new wt({props:{$$slots:{default:[Ge]},$$scope:{ctx:o}}});let s=o[0],l=[];for(let f=0;f<s.length;f+=1)l[f]=$t(gt(o,s,f));const m=f=>D(l[f],1,1,()=>{l[f]=null});return{c(){C(e.$$.fragment),t=H(),C(n.$$.fragment),r=H();for(let f=0;f<l.length;f+=1)l[f].c();i=J()},l(f){M(e.$$.fragment,f),t=Q(f),M(n.$$.fragment,f),r=Q(f);for(let c=0;c<l.length;c+=1)l[c].l(f);i=J()},m(f,c){R(e,f,c),k(f,t,c),R(n,f,c),k(f,r,c);for(let h=0;h<l.length;h+=1)l[h].m(f,c);k(f,i,c),a=!0},p(f,c){const h={};c&64&&(h.$$scope={dirty:c,ctx:f}),e.$set(h);const u={};if(c&64&&(u.$$scope={dirty:c,ctx:f}),n.$set(u),c&1){s=f[0];let p;for(p=0;p<s.length;p+=1){const d=gt(f,s,p);l[p]?(l[p].p(d,c),w(l[p],1)):(l[p]=$t(d),l[p].c(),w(l[p],1),l[p].m(i.parentNode,i))}for(it(),p=s.length;p<l.length;p+=1)m(p);st()}},i(f){if(!a){w(e.$$.fragment,f),w(n.$$.fragment,f);for(let c=0;c<s.length;c+=1)w(l[c]);a=!0}},o(f){D(e.$$.fragment,f),D(n.$$.fragment,f),l=l.filter(Boolean);for(let c=0;c<l.length;c+=1)D(l[c]);a=!1},d(f){E(e,f),f&&v(t),E(n,f),f&&v(r),St(l,f),f&&v(i)}}}function Ye(o){let e,t,n;return t=new Bt({props:{$$slots:{default:[Ke]},$$scope:{ctx:o}}}),{c(){e=L("div"),C(t.$$.fragment)},l(r){e=I(r,"DIV",{});var i=P(e);M(t.$$.fragment,i),i.forEach(v)},m(r,i){k(r,e,i),R(t,e,null),n=!0},p(r,[i]){const a={};i&64&&(a.$$scope={dirty:i,ctx:r}),t.$set(a)},i(r){n||(w(t.$$.fragment,r),n=!0)},o(r){D(t.$$.fragment,r),n=!1},d(r){r&&v(e),E(t)}}}function Ze(o){return[[{title:"V7",component:Oe},{title:"V6",component:xe},{title:"V5",component:ve},{title:"V4",component:ue},{title:"V3",component:le},{title:"V2",component:qt},{title:"V1",component:Xt}]]}class He extends T{constructor(e){super(),W(this,e,Ze,Ye,F,{})}}function Qe(o){let e,t;return e=new He({}),{c(){C(e.$$.fragment)},l(n){M(e.$$.fragment,n)},m(n,r){R(e,n,r),t=!0},p:S,i(n){t||(w(e.$$.fragment,n),t=!0)},o(n){D(e.$$.fragment,n),t=!1},d(n){E(e,n)}}}class ln extends T{constructor(e){super(),W(this,e,null,Qe,F,{})}}export{ln as default};
