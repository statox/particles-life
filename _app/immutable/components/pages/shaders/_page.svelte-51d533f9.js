import{S as T,i as _,s as g,k as S,l as P,m as U,h,n as D,b as L,B as m,o as N,w as v,x as C,y as I,f as F,t as w,z as $}from"../../../chunks/index-a8a449af.js";const b=["VERTEX_SHADER","FRAGMENT_SHADER"];function X(r,e,o,n,c){const i=[];for(let a=0;a<e.length;++a)i.push(y(r,e[a],r[b[a]],c));return M(r,i,o,n,c)}function y(r,e,o,n){const c=n||console.log,i=r.createShader(o);if(!i)throw"Could not load shader";if(r.shaderSource(i,e),r.compileShader(i),!r.getShaderParameter(i,r.COMPILE_STATUS)){const t=r.getShaderInfoLog(i);return c(new Error("*** Error compiling shader '"+i+"':"+t+`
`+e.split(`
`).map((s,d)=>`${d+1}: ${s}`).join(`
